<!DOCTYPE html>
<!--
Template Name: M-Technolabs - Vuejs, HTML & Laravel Admin Dashboard Template
Author: PixInvent
Website: http://www.pixinvent.com/
Contact: hello@pixinvent.com
Follow: www.twitter.com/pixinvents
Like: www.facebook.com/pixinvents
Purchase: https://1.envato.market/M-Technolabs_admin
Renew Support: https://1.envato.market/M-Technolabs_admin
...
<!-- Mirrored from pixinvent.com/demo/M-Technolabs-html-bootstrap-admin-template/html/ltr/vertical-menu-template/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Aug 2021 13:14:15 GMT -->
...
<head>
    ...
    <meta name="description"
        content="M-Technolabs admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin template, M-Technolabs admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>{{$title ?? 'Alternat'}} || Learning Test App</title>
    <link rel="apple-touch-icon" href="/app-assets/images/ico/apple-icon-120.html">
    <link rel="shortcut icon" type="image/x-icon"
        href="https://pixinvent.com/demo/M-Technolabs-html-bootstrap-admin-template/app-assets/images/ico/favicon.ico">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{auth()->user()->name}}</span><span
                                class="user-status">{{auth()->user()->email}}</span></div><span class="avatar"><img class="round"
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="/"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">M-Technolabs</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" navigation-header"><span data-i18n="Master">Pelatihan</span><i
                ...
                <li class="{{$dash_active ?? ''}} nav-item"><a class="d-flex align-items-center" href="/dash"><i
                            ...
                            data-i18n="pelatihan">Pelatihan</span></a>
                </li>
                <li class="{{$infobayar_active ?? ''}} nav-item"><a class="d-flex align-items-center" href="/infobayar"><i
                    data-feather="dollar-sign"></i><span class="menu-title text-truncate"
                    data-i18n="pelatihan">Informasi Pembayaran</span></a>
                </li>
            </ul>
        </div>
    </div>
